...
public class CarPriceEstimator {
    ...
    public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven,
        ...
        System.out.println("Price before discount: "+ salePrice);

        if (ageOfCar <= 10){
            salePrice -= ((ageOfCar * 5) * 0.01) * salePrice;
        } else {
        ...
        // 2. Security Features
        //      if car does NOT have at least two airbags AND abs AND ebd
        ...
        System.out.println(additionalMiles);
